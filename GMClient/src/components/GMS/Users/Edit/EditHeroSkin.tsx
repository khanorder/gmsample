...
const HeroSkinContents = dynamic(() => import('./EditHeroSkinContents'), { ssr: false });
...
export interface HeroSkinProps {
    heroSkins: Models.HeroSkin[]|null;
}

const EditHeroSkin = ({ heroSkins }: HeroSkinProps): ReactElement => {

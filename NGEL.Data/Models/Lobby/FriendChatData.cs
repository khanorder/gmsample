...
public struct FriendChatData : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_20(); }
  public static FriendChatData GetRootAsFriendChatData(ByteBuffer _bb) { return GetRootAsFriendChatData(_bb, new FriendChatData()); }
  public static FriendChatData GetRootAsFriendChatData(ByteBuffer _bb, FriendChatData obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public FriendChatData __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<Lobby.FriendChatData> CreateFriendChatData(FlatBufferBuilder builder,
      int UID = 0,
      int FriendUID = 0,
      long Serial = 0,
    ...
    FriendChatData.AddSerial(builder, Serial);
    FriendChatData.AddChatAt(builder, ChatAt);
    FriendChatData.AddMessage(builder, MessageOffset);
    FriendChatData.AddFriendUID(builder, FriendUID);
    FriendChatData.AddUID(builder, UID);
    return FriendChatData.EndFriendChatData(builder);
  }

  public static void StartFriendChatData(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<Lobby.FriendChatData> EndFriendChatData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Lobby.FriendChatData>(o);
  }
  public FriendChatDataT UnPack() {
    var _o = new FriendChatDataT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(FriendChatDataT _o) {
    _o.UID = this.UID;
  ...
  public static Offset<Lobby.FriendChatData> Pack(FlatBufferBuilder builder, FriendChatDataT _o) {
    if (_o == null) return default(Offset<Lobby.FriendChatData>);
    var _Message = _o.Message == null ? default(StringOffset) : builder.CreateString(_o.Message);
    return CreateFriendChatData(
      builder,
      _o.UID,
      _o.FriendUID,
      _o.Serial,

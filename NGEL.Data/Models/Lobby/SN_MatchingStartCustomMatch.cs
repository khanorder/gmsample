...
public struct SN_MatchingStartCustomMatch : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_20(); }
  public static SN_MatchingStartCustomMatch GetRootAsSN_MatchingStartCustomMatch(ByteBuffer _bb) { return GetRootAsSN_MatchingStartCustomMatch(_bb, new SN_MatchingStartCustomMatch()); }
  public static SN_MatchingStartCustomMatch GetRootAsSN_MatchingStartCustomMatch(ByteBuffer _bb, SN_MatchingStartCustomMatch obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SN_MatchingStartCustomMatch __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public int ConfirmTimeout { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Lobby.MatchingTeamInfo? TeamList(int j) { int o = __p.__offset(10); return o != 0 ? (Lobby.MatchingTeamInfo?)(new Lobby.MatchingTeamInfo()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int TeamListLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Lobby.SN_MatchingStartCustomMatch> CreateSN_MatchingStartCustomMatch(FlatBufferBuilder builder,
    ...
    SN_MatchingStartCustomMatch.AddTeamList(builder, TeamListOffset);
    SN_MatchingStartCustomMatch.AddConfirmTimeout(builder, ConfirmTimeout);
    SN_MatchingStartCustomMatch.AddMatchID(builder, MatchIDOffset);
    SN_MatchingStartCustomMatch.AddMatchingTableID(builder, MatchingTableID);
    return SN_MatchingStartCustomMatch.EndSN_MatchingStartCustomMatch(builder);
  }

  public static void StartSN_MatchingStartCustomMatch(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static void AddConfirmTimeout(FlatBufferBuilder builder, int ConfirmTimeout) { builder.AddInt(2, ConfirmTimeout, 0); }
  public static void AddTeamList(FlatBufferBuilder builder, VectorOffset TeamListOffset) { builder.AddOffset(3, TeamListOffset.Value, 0); }
  ...
  public static Offset<Lobby.SN_MatchingStartCustomMatch> EndSN_MatchingStartCustomMatch(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Lobby.SN_MatchingStartCustomMatch>(o);
  }
  public SN_MatchingStartCustomMatchT UnPack() {
    var _o = new SN_MatchingStartCustomMatchT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SN_MatchingStartCustomMatchT _o) {
  ...
  public static Offset<Lobby.SN_MatchingStartCustomMatch> Pack(FlatBufferBuilder builder, SN_MatchingStartCustomMatchT _o) {
    if (_o == null) return default(Offset<Lobby.SN_MatchingStartCustomMatch>);
    ...
    return CreateSN_MatchingStartCustomMatch(
      builder,
      _o.MatchingTableID,
      _MatchID,
      _o.ConfirmTimeout,
...
public class SN_MatchingStartCustomMatchT
{
  ...
  public SN_MatchingStartCustomMatchT() {

...
public struct SA_PenaltyList : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_20(); }
  public static SA_PenaltyList GetRootAsSA_PenaltyList(ByteBuffer _bb) { return GetRootAsSA_PenaltyList(_bb, new SA_PenaltyList()); }
  public static SA_PenaltyList GetRootAsSA_PenaltyList(ByteBuffer _bb, SA_PenaltyList obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SA_PenaltyList __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<Lobby.SA_PenaltyList> CreateSA_PenaltyList(FlatBufferBuilder builder,
      VectorOffset PenaltyListOffset = default(VectorOffset),
      StringOffset NewNickOffset = default(StringOffset)) {
    builder.StartTable(2);
    SA_PenaltyList.AddNewNick(builder, NewNickOffset);
    SA_PenaltyList.AddPenaltyList(builder, PenaltyListOffset);
    return SA_PenaltyList.EndSA_PenaltyList(builder);
  }

  public static void StartSA_PenaltyList(FlatBufferBuilder builder) { builder.StartTable(2); }
  ...
  public static Offset<Lobby.SA_PenaltyList> EndSA_PenaltyList(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Lobby.SA_PenaltyList>(o);
  }
  public SA_PenaltyListT UnPack() {
    var _o = new SA_PenaltyListT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SA_PenaltyListT _o) {
  ...
  public static Offset<Lobby.SA_PenaltyList> Pack(FlatBufferBuilder builder, SA_PenaltyListT _o) {
    if (_o == null) return default(Offset<Lobby.SA_PenaltyList>);

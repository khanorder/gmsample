...
public struct SN_PenaltyReport : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_20(); }
  public static SN_PenaltyReport GetRootAsSN_PenaltyReport(ByteBuffer _bb) { return GetRootAsSN_PenaltyReport(_bb, new SN_PenaltyReport()); }
  public static SN_PenaltyReport GetRootAsSN_PenaltyReport(ByteBuffer _bb, SN_PenaltyReport obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SN_PenaltyReport __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<Lobby.SN_PenaltyReport> CreateSN_PenaltyReport(FlatBufferBuilder builder,
      VectorOffset PenaltyListOffset = default(VectorOffset),
      StringOffset NewNickOffset = default(StringOffset)) {
    builder.StartTable(2);
    SN_PenaltyReport.AddNewNick(builder, NewNickOffset);
    SN_PenaltyReport.AddPenaltyList(builder, PenaltyListOffset);
    return SN_PenaltyReport.EndSN_PenaltyReport(builder);
  }

  public static void StartSN_PenaltyReport(FlatBufferBuilder builder) { builder.StartTable(2); }
  ...
  public static Offset<Lobby.SN_PenaltyReport> EndSN_PenaltyReport(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Lobby.SN_PenaltyReport>(o);
  }
  public SN_PenaltyReportT UnPack() {
    var _o = new SN_PenaltyReportT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SN_PenaltyReportT _o) {
  ...
  public static Offset<Lobby.SN_PenaltyReport> Pack(FlatBufferBuilder builder, SN_PenaltyReportT _o) {
    if (_o == null) return default(Offset<Lobby.SN_PenaltyReport>);

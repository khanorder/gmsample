...
public struct SA_MailReceive : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_20(); }
  public static SA_MailReceive GetRootAsSA_MailReceive(ByteBuffer _bb) { return GetRootAsSA_MailReceive(_bb, new SA_MailReceive()); }
  public static SA_MailReceive GetRootAsSA_MailReceive(ByteBuffer _bb, SA_MailReceive obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SA_MailReceive __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<Lobby.SA_MailReceive> CreateSA_MailReceive(FlatBufferBuilder builder,
      bool IsBM = false,
    ...
    SA_MailReceive.AddReward(builder, RewardOffset);
    SA_MailReceive.AddDeleteHistoryIDList(builder, DeleteHistoryIDListOffset);
    SA_MailReceive.AddAddHistoryList(builder, AddHistoryListOffset);
    SA_MailReceive.AddDeleteMailIDList(builder, DeleteMailIDListOffset);
    SA_MailReceive.AddIsBM(builder, IsBM);
    return SA_MailReceive.EndSA_MailReceive(builder);
  }

  public static void StartSA_MailReceive(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<Lobby.SA_MailReceive> EndSA_MailReceive(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Lobby.SA_MailReceive>(o);
  }
  public SA_MailReceiveT UnPack() {
    var _o = new SA_MailReceiveT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SA_MailReceiveT _o) {
    _o.IsBM = this.IsBM;
  ...
  public static Offset<Lobby.SA_MailReceive> Pack(FlatBufferBuilder builder, SA_MailReceiveT _o) {
    if (_o == null) return default(Offset<Lobby.SA_MailReceive>);

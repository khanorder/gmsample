...
{
    public class SilverMedalStoreDataTableService
    {
        private string tableName = "SilverMedalStoreDataTable";
        private string csvFileName = "tb_SilverMedalStore";
        private readonly ILogger<SilverMedalStoreDataTableService> _logger;
        private double _version { get; set; } = 0;
        private List<NGEL.Data.Tables.Models.SilverMedalStoreData> _datas { get; set; } = new List<NGEL.Data.Tables.Models.SilverMedalStoreData>();
        public double version { get => _version; }
        public List<NGEL.Data.Tables.Models.SilverMedalStoreData> datas { get => _datas; }
        private object lockObject = new object();

        public SilverMedalStoreDataTableService(ILogger<SilverMedalStoreDataTableService> logger)
        {
            _logger = logger;
        }
        ...
        public void LoadTable()
        {
            ...
            using (var csv = new CsvReader(reader, config))
            {
                ...
                csv.Context.RegisterClassMap<SilverMedalStoreDataMap>();
                csv.Read();
                csv.ReadHeader();
                Int64 rowIndex = 0;
                ...
                while (csv.Read())
                {
                    ...
                    var data = new NGEL.Data.Tables.Models.SilverMedalStoreData
                    {
                        ID = ID,
                        Enable = Enable,

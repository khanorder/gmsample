...
{
    public class SkinDataTableService
    {
        private string tableName = "SkinDataTable";
        private string csvFileName = "tb_Skin";
        private readonly ILogger<SkinDataTableService> _logger;
        private double _version { get; set; } = 0;
        private List<NGEL.Data.Tables.Models.SkinData> _datas { get; set; } = new List<NGEL.Data.Tables.Models.SkinData>();
        public double version { get => _version; }
        public List<NGEL.Data.Tables.Models.SkinData> datas { get => _datas; }
        private object lockObject = new object();

        public SkinDataTableService(ILogger<SkinDataTableService> logger)
        {
            _logger = logger;
        }
        ...
        public void LoadTable()
        {
            ...
            using (var csv = new CsvReader(reader, config))
            {
                ...
                csv.Context.RegisterClassMap<SkinDataMap>();
                csv.Read();
                csv.ReadHeader();
                Int64 rowIndex = 0;
                ...
                while (csv.Read())
                {
                    ...
                    var data = new NGEL.Data.Tables.Models.SkinData
                    {
                        ID = ID,
                        Name = Name,
                    };

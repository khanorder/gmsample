...
{
    public class VehicleDataTableService
    {
        private string tableName = "VehicleDataTable";
        private string csvFileName = "tb_Vehicle";
        private readonly ILogger<VehicleDataTableService> _logger;
        private double _version { get; set; } = 0;
        private List<NGEL.Data.Tables.Models.VehicleData> _datas { get; set; } = new List<NGEL.Data.Tables.Models.VehicleData>();
        public double version { get => _version; }
        public List<NGEL.Data.Tables.Models.VehicleData> datas { get => _datas; }
        private object lockObject = new object();

        public VehicleDataTableService(ILogger<VehicleDataTableService> logger)
        {
            _logger = logger;
        }
        ...
        public void LoadTable()
        {
            ...
            using (var csv = new CsvReader(reader, config))
            {
                ...
                while (csv.Read())
                {
                    ...
                    {
                        Type = "";
                        _logger.LogError($"{tableName}({rowIndex}): Member Type is null.");
                    }
                    ...
                    var data = new NGEL.Data.Tables.Models.VehicleData
                    {
                        ID = ID,

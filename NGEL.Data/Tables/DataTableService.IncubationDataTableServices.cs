...
{
    public class IncubationDataTableService
    {
        private string tableName = "IncubationDataTable";
        private string csvFileName = "tb_Incubation";
        private readonly ILogger<IncubationDataTableService> _logger;
        private double _version { get; set; } = 0;
        private List<NGEL.Data.Tables.Models.IncubationData> _datas { get; set; } = new List<NGEL.Data.Tables.Models.IncubationData>();
        public double version { get => _version; }
        public List<NGEL.Data.Tables.Models.IncubationData> datas { get => _datas; }
        private object lockObject = new object();

        public IncubationDataTableService(ILogger<IncubationDataTableService> logger)
        {
            _logger = logger;
        }
        ...
        public void LoadTable()
        {
            ...
            using (var csv = new CsvReader(reader, config))
            {
                ...
                csv.Context.RegisterClassMap<IncubationDataMap>();
                csv.Read();
                csv.ReadHeader();
                Int64 rowIndex = 0;
                ...
                while (csv.Read())
                {
                    ...
                    var data = new NGEL.Data.Tables.Models.IncubationData
                    {
                        ID = ID,
                        Name = Name,
                    };

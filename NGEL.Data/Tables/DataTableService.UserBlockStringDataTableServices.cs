...
{
    public class UserBlockStringDataTableService
    {
        private string tableName = "UserBlockStringDataTable";
        private string csvFileName = "tb_UserBlockString";
        private readonly ILogger<UserBlockStringDataTableService> _logger;
        private double _version { get; set; } = 0;
        private List<NGEL.Data.Tables.Models.UserBlockStringData> _datas { get; set; } = new List<NGEL.Data.Tables.Models.UserBlockStringData>();
        public double version { get => _version; }
        public List<NGEL.Data.Tables.Models.UserBlockStringData> datas { get => _datas; }
        private object lockObject = new object();

        public UserBlockStringDataTableService(ILogger<UserBlockStringDataTableService> logger)
        {
            _logger = logger;
        }
        ...
        public void LoadTable()
        {
            ...
            using (var csv = new CsvReader(reader, config))
            {
                ...
                csv.Context.RegisterClassMap<UserBlockStringDataMap>();
                csv.Read();
                csv.ReadHeader();
                Int64 rowIndex = 0;
                ...
                while (csv.Read())
                {
                    ...
                    var data = new NGEL.Data.Tables.Models.UserBlockStringData
                    {
                        Key = Key,

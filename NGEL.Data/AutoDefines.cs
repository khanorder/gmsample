...
namespace NGEL.Data
{
    public partial class Defines
    {
        public enum DatabaseRole
        {
            None,
            GameManager = 1, //운영툴디비
            GameManagerWriteOnly = 2, //운영툴디비 쓰지전용
            Game = 3, //게임디비
            GameWriteOnly = 4, //게임디비 쓰기전용
            Admin = 5, //운영디비
            AdminWriteOnly = 6, //인증디비 쓰기전용
            Visit = 7, //방문자디비
            VisitWriteOnly = 8, //방문자디비 쓰기전용
            Log = 91, //로그디비
            ActiveUser = 92, //실시간접속
            ChatLog = 93, //채팅로그디비
            GMLog = 98, //운영툴 로그디비
            GMLogWriteOnly = 99, //운영툴 로그디비 쓰기전용
        }

        public enum DatabaseType
        {
            MYSQL = 0, //mysql/mariadb
            MSSQL = 1, //Microsoft SQL Server
            Redis = 11, //Redis
        }
        ...
        public enum ServiceVersionManagementPlatform
        {
            None = 0,
            PC = 1,
            AOS = 2,
        ...
        public enum ServiceVersionManagementServerState
        {
            None = 0,
            Private = 1,
            Beta = 2,
        ...
        public enum ServiceVersionManagementClientState
        {
            None = 0,
            Service = 1,
            RecomUpdate = 2,
        ...
        public enum MaintenancePlatform
        {
            None = 0,
            PC = 1,
            AOS = 2,
        ...
        public enum ChattingNoticeType
        {
            None = 0,
            Fixed = 1, //고정
            LeftScroll = 2, //좌측 스크롤
